...
The trial takes a few minutes to load, then you can start using the app. See [Additional requirements and limitations](../troubleshoot-faqs/requirements-limitations.md) if you're having problems signing up.
